...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card { background: #0F1115; border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; }
  ...
  .btn-primary { background: linear-gradient(to right, #EA580C, #F7931A); border: none; color: #fff; font-family: 'Space Grotesk', sans-serif; font-weight: 600; font-size: 13px; letter-spacing: 0.06em; text-transform: uppercase; border-radius: 9999px; padding: 10px 22px; cursor: pointer; transition: all 0.25s; box-shadow: 0 0 18px -5px rgba(234,88,12,0.45); display: inline-flex; align-items: center; gap: 8px; justify-content: center; }
  .btn-primary:hover { transform: scale(1.04); box-shadow: 0 0 28px -4px rgba(247,147,26,0.65); }
  .btn-primary:disabled { opacity: 0.5; cursor: not-allowed; transform: none; }
  .btn-ghost { background: transparent; border: 1px solid rgba(255,255,255,0.13); color: rgba(255,255,255,0.6); font-family: 'Space Grotesk', sans-serif; font-size: 13px; border-radius: 9999px; padding: 9px 20px; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 6px; }
  .btn-ghost:hover { border-color: rgba(255,255,255,0.4); color: #fff; }
  .btn-ghost:disabled { opacity: 0.5; cursor: not-allowed; }
  .btn-danger { background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.3); color: #f87171; font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.06em; border-radius: 8px; padding: 5px 14px; cursor: pointer; transition: all 0.2s; }
  ...
  .field-input { width: 100%; background: rgba(0,0,0,0.45); border: 1px solid rgba(255,255,255,0.09); border-radius: 8px; color: #fff; font-family: 'Space Grotesk', sans-serif; font-size: 14px; padding: 10px 14px; outline: none; transition: border-color 0.2s, box-shadow 0.2s; }
  ...
  .tab-btn { font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; padding: 9px 18px; border-radius: 10px; cursor: pointer; border: 1px solid transparent; transition: all 0.2s; }
